...
const logoUrl = "/assets/Damru-logo.svg";
    ...
    <footer className="bg-black text-white w-full h-[40vh]">
      <div className="container mx-auto flex justify-between items-center px-8 h-full">
        ...
        <div className="flex items-center gap-6">
          <a
            href="mailto:fest@rishihood.edu.in"
          ...
          <a
            href="https://www.instagram.com/damrufest/"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/company/damrufest/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-gray-300 transition-colors"
          >
