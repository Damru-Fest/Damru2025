...
export default function AddWorkshop() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("registrationDeadline", workshop.registrationDeadline);
      ...
      await axiosInstance.post("/workshops", formData, {
        headers: {
        ...
        <Card className="w-96">
          <CardContent className="pt-6">
            <div className="text-center text-green-600">
              ...
              <p className="font-semibold text-lg">Workshop Created!</p>
              <p className="text-sm mt-2">Redirecting to workshop list...</p>
            </div>
          </CardContent>
        </Card>
      </div>
