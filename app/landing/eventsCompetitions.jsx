...
const EventsCompetitions = () => {
  ...
  const handleEventTimeUpdate = () => {
    ...
    if (eventVideoRef.current) {
      ...
      const endTime = video.duration - 20
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#3f0f0f] overflow-hidden">
      ...
      <Image
        ...
        width={500}
        height={500}
        className="absolute left-0 top-1/2 -translate-y-1/1 sm:-translate-y-1/2 w-[250px] md:w-[500px] h-auto opacity-20 md:opacity-30 pointer-events-none select-none"
      ...
      <Image
        ...
        width={500}
        height={500}
        className="absolute right-0 top-1/2 translate-y-1/1 sm:-translate-y-1/2 w-[250px] md:w-[500px] h-auto opacity-20 md:opacity-30 pointer-events-none select-none"
        style={{ animation: 'spin 25s linear infinite' }}
      />
          ...
          {activeGate === null ? (
            ...
            <motion.div
              ...
              animate={{
                ...
                transition: { duration: isVideoEnded ? 4.5 : 3.5, 
                  ease: 'easeInOut' },
              }}
